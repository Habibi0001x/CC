...
local Themes = {
    ...
    Dark = {
        ...
        LockedColor = Color3.fromRGB(60, 60, 70),
        LockedTextColor = Color3.fromRGB(100, 100, 110)
    },
    Light = {
        MainColor = Color3.fromRGB(245, 245, 250),
        SecondaryColor = Color3.fromRGB(235, 235, 240),
        AccentColor = Color3.fromRGB(70, 85, 220),
        TextColor = Color3.fromRGB(30, 30, 40),
        SecondaryTextColor = Color3.fromRGB(100, 100, 110),
        BorderColor = Color3.fromRGB(200, 200, 210),
        ToggleOnColor = Color3.fromRGB(70, 85, 220),
        ToggleOffColor = Color3.fromRGB(180, 180, 190),
        LockedColor = Color3.fromRGB(210, 210, 220),
    ...
    Ocean = {
        ...
        TextColor = Color3.fromRGB(255, 255, 255),
        SecondaryTextColor = Color3.fromRGB(150, 180, 200),
        BorderColor = Color3.fromRGB(50, 70, 90),
        ToggleOnColor = Color3.fromRGB(0, 180, 220),
        ToggleOffColor = Color3.fromRGB(50, 70, 90),
        LockedColor = Color3.fromRGB(40, 55, 75),
        LockedTextColor = Color3.fromRGB(100, 130, 150)
    },
    Forest = {
        MainColor = Color3.fromRGB(25, 35, 25),
        SecondaryColor = Color3.fromRGB(35, 50, 35),
        AccentColor = Color3.fromRGB(80, 200, 120),
        TextColor = Color3.fromRGB(255, 255, 255),
        SecondaryTextColor = Color3.fromRGB(170, 200, 170),
        BorderColor = Color3.fromRGB(55, 75, 55),
        ToggleOnColor = Color3.fromRGB(80, 200, 120),
        ToggleOffColor = Color3.fromRGB(55, 75, 55),
        LockedColor = Color3.fromRGB(45, 60, 45),
        LockedTextColor = Color3.fromRGB(110, 140, 110)
    },
    Sunset = {
        MainColor = Color3.fromRGB(40, 25, 30),
        SecondaryColor = Color3.fromRGB(55, 35, 45),
        AccentColor = Color3.fromRGB(255, 120, 80),
        TextColor = Color3.fromRGB(255, 255, 255),
        SecondaryTextColor = Color3.fromRGB(200, 170, 175),
        BorderColor = Color3.fromRGB(80, 55, 65),
        ToggleOnColor = Color3.fromRGB(255, 120, 80),
        ToggleOffColor = Color3.fromRGB(80, 55, 65),
        LockedColor = Color3.fromRGB(65, 45, 55),
        LockedTextColor = Color3.fromRGB(140, 110, 120)
    },
    Purple = {
        MainColor = Color3.fromRGB(30, 25, 45),
        SecondaryColor = Color3.fromRGB(45, 35, 65),
        AccentColor = Color3.fromRGB(180, 100, 255),
        TextColor = Color3.fromRGB(255, 255, 255),
        SecondaryTextColor = Color3.fromRGB(180, 170, 200),
        BorderColor = Color3.fromRGB(70, 55, 90),
        ToggleOnColor = Color3.fromRGB(180, 100, 255),
        ToggleOffColor = Color3.fromRGB(70, 55, 90),
        LockedColor = Color3.fromRGB(55, 45, 75),
        LockedTextColor = Color3.fromRGB(130, 110, 150)
    },
    Rose = {
        MainColor = Color3.fromRGB(35, 25, 30),
        SecondaryColor = Color3.fromRGB(50, 35, 42),
        AccentColor = Color3.fromRGB(255, 100, 150),
        TextColor = Color3.fromRGB(255, 255, 255),
        SecondaryTextColor = Color3.fromRGB(200, 175, 185),
        BorderColor = Color3.fromRGB(75, 55, 65),
        ToggleOnColor = Color3.fromRGB(255, 100, 150),
        ToggleOffColor = Color3.fromRGB(75, 55, 65),
        LockedColor = Color3.fromRGB(60, 45, 52),
        LockedTextColor = Color3.fromRGB(140, 115, 125)
    },
    Midnight = {
        MainColor = Color3.fromRGB(10, 10, 18),
        SecondaryColor = Color3.fromRGB(18, 18, 28),
        AccentColor = Color3.fromRGB(130, 140, 255),
        TextColor = Color3.fromRGB(230, 230, 245),
        SecondaryTextColor = Color3.fromRGB(140, 140, 160),
        BorderColor = Color3.fromRGB(35, 35, 50),
        ToggleOnColor = Color3.fromRGB(130, 140, 255),
        ToggleOffColor = Color3.fromRGB(40, 40, 55),
        LockedColor = Color3.fromRGB(30, 30, 42),
        LockedTextColor = Color3.fromRGB(90, 90, 105)
    },
    Aqua = {
        MainColor = Color3.fromRGB(20, 35, 40),
        SecondaryColor = Color3.fromRGB(30, 50, 55),
        AccentColor = Color3.fromRGB(0, 220, 200),
        TextColor = Color3.fromRGB(255, 255, 255),
        SecondaryTextColor = Color3.fromRGB(160, 200, 195),
        BorderColor = Color3.fromRGB(50, 75, 80),
        ToggleOnColor = Color3.fromRGB(0, 220, 200),
        ToggleOffColor = Color3.fromRGB(50, 75, 80),
        LockedColor = Color3.fromRGB(40, 60, 65),
        LockedTextColor = Color3.fromRGB(110, 145, 140)
    },
    Blood = {
        MainColor = Color3.fromRGB(25, 15, 15),
        SecondaryColor = Color3.fromRGB(40, 22, 22),
        AccentColor = Color3.fromRGB(200, 40, 40),
        TextColor = Color3.fromRGB(255, 255, 255),
        SecondaryTextColor = Color3.fromRGB(180, 150, 150),
        BorderColor = Color3.fromRGB(70, 40, 40),
        ToggleOnColor = Color3.fromRGB(200, 40, 40),
        ToggleOffColor = Color3.fromRGB(70, 40, 40),
        LockedColor = Color3.fromRGB(55, 30, 30),
        LockedTextColor = Color3.fromRGB(130, 90, 90)
    },
    Gold = {
        MainColor = Color3.fromRGB(30, 28, 20),
        SecondaryColor = Color3.fromRGB(45, 42, 30),
        AccentColor = Color3.fromRGB(255, 200, 50),
        TextColor = Color3.fromRGB(255, 255, 255),
        SecondaryTextColor = Color3.fromRGB(200, 190, 160),
        BorderColor = Color3.fromRGB(80, 75, 50),
        ToggleOnColor = Color3.fromRGB(255, 200, 50),
        ToggleOffColor = Color3.fromRGB(80, 75, 50),
        LockedColor = Color3.fromRGB(60, 56, 40),
        LockedTextColor = Color3.fromRGB(150, 140, 100)
    }
}
...
local LucideIcons = {
    ...
    Folder = "rbxassetid://7733697276",
    File = "rbxassetid://7733680183",
    Refresh = "rbxassetid://7733992450",
    Trash = "rbxassetid://7743878857",
    Download = "rbxassetid://7733715400",
    Upload = "rbxassetid://7733715400"
}
...
function ConfigSystem:Init(configName)
    ...
    local gameFolder = self.Folder .. "/" .. tostring(game.PlaceId)
...
function ConfigSystem:RegisterFlag(flag, getFunc, setFunc)
    self.Flags[flag] = {
        Get = getFunc,
        Set = setFunc
    }
...
function Library:CreateWindow(options)
    ...
    -- Store elements that need theme updates
    local function RegisterThemeElement(element, property, configKey)
        table.insert(Window.ThemeElements, {Element = element, Property = property, ConfigKey = configKey})
    end
    
    RegisterThemeElement(MainFrame, "BackgroundColor3", "MainColor")
    RegisterThemeElement(TitleBar, "BackgroundColor3", "SecondaryColor")
    RegisterThemeElement(TabContainer, "BackgroundColor3", "SecondaryColor")
    RegisterThemeElement(ContentContainer, "BackgroundColor3", "SecondaryColor")
    ...
    function Window:SetTheme(themeName)
        ...
        for _, info in ipairs(self.ThemeElements) do
            if info.Element and info.Element.Parent then
                local value = Config[info.ConfigKey]
                if value then
                    Tween(info.Element, {[info.Property] = value})
                end
            end
        end
        ...
        Tween(TitleBar, {BackgroundColor3 = Config.SecondaryColor})
        Tween(TabContainer, {BackgroundColor3 = Config.SecondaryColor})
        Tween(ContentContainer, {BackgroundColor3 = Config.SecondaryColor})
        
        TitleBar:FindFirstChild("Icon").ImageColor3 = Config.AccentColor
        TitleBar:FindFirstChild("Title").TextColor3 = Config.TextColor
        TitleBar:FindFirstChild("Description").TextColor3 = Config.SecondaryTextColor
    end
    ...
    function Window:CreateTab(options)
        ...
        function Tab:CreateSection(options)
            ...
            function Section:CreateToggle(options)
                ...
                if flag then
                    ConfigSystem:RegisterFlag(flag, function() return toggled end, function(v) toggled = v; Update() end)
                end
            ...
            function Section:CreateSlider(options)
                ...
                if flag then
                    ConfigSystem:RegisterFlag(flag, function() return value end, function(v) sliderObj:Set(v) end)
                end
            ...
            if flag then
                ConfigSystem:RegisterFlag(flag, function() return selected end, function(v) dropdownObj:SetValue(v) end)
            end
        ...
        function Section:CreateInput(options)
            ...
            if flag then
                ConfigSystem:RegisterFlag(flag, function() return TextBox.Text end, function(v) TextBox.Text = v end)
            end
        ...
        function Section:CreateColorPicker(options)
            ...
            if flag then
                ConfigSystem:RegisterFlag(flag, function() return color end, function(c) colorObj:SetColor(c) end)
            end
        ...
        function Section:CreateKeybind(options)
            ...
            if flag then
                ConfigSystem:RegisterFlag(flag, function() return key end, function(k) keybindObj:SetKey(k) end)
            end
...
-- Create Settings Tab with Config System
function Window:CreateSettingsTab(options)
    ...
    ConfigSection:CreateButton({
        ...
        Description = "Overwrite the selected config with current settings",
        Icon = "Edit",
        Callback = function()
            local selected = configDropdown:GetValue()
            if selected then
                Window:CreateDialog({
                    ...
                    Content = "Are you sure you want to overwrite '" .. selected .. "'?",
                    Buttons = {
                        {
                            Text = "Overwrite",
                            Callback = function()
                                if ConfigSystem:Save(selected) then
                                    Window:Notify({
                                        Title = "Config Overwritten",
                                        Content = "Successfully overwrote config: " .. selected,
                                        Duration = 3,
                                        Type = "Success"
                                    })
                                end
    ...
    -- Autoload Section
    local AutoloadSection = SettingsTab:CreateSection({
        Name = "Auto Load",
        Description = "Automatically load a config on startup"
    })
    
    local currentAutoload = ConfigSystem:GetAutoload()
    
    local autoloadLabel = AutoloadSection:CreateLabel({
        Text = "Current Autoload: " .. (currentAutoload or "None"),
        Icon = "Star"
    })
    
    AutoloadSection:CreateButton({
        Text = "Set as Autoload",
        Description = "Set the selected config to load automatically",
        Icon = "Star",
        Callback = function()
            local selected = configDropdown:GetValue()
            if selected then
                if ConfigSystem:SetAutoload(selected) then
                    autoloadLabel:SetText("Current Autoload: " .. selected)
                    Window:Notify({
                        Title = "Autoload Set",
                        Content = "Config '" .. selected .. "' will load automatically",
                        Duration = 3,
                        Type = "Success"
                    })
                end
    ...
    AutoloadSection:CreateButton({
        Text = "Clear Autoload",
        Description = "Remove the autoload config",
        Icon = "X",
        Callback = function()
            if ConfigSystem:ClearAutoload() then
                autoloadLabel:SetText("Current Autoload: None")
                Window:Notify({
                    Title = "Autoload Cleared",
                    Content = "No config will load automatically",
                    Duration = 3,
                    Type = "Info"
                })
            end
    ...
    -- Anti-AFK Section
    local AntiAFKSection = SettingsTab:CreateSection({
        Name = "Anti-AFK",
    ...
    task.defer(function()
        task.wait(0.5)
        if ConfigSystem:LoadAutoload() then
            Window:Notify({
                Title = "Config Auto-Loaded",
                Content = "Loaded config: " .. (ConfigSystem:GetAutoload() or "Unknown"),
                Duration = 3,
                Type = "Success"
            })
        end
...
-- Add to the Library table before return
Library.Version = "2.0.0"
Library.Author = "Advanced UI Library"

-- Utility function to create a complete window with settings
function Library:CreateFullWindow(options)
    options = options or {}
    local Window = self:CreateWindow(options)
    
    -- Auto-create settings tab if requested
    if options.AutoSettings ~= false then
        Window:CreateSettingsTab({
            Name = options.SettingsTabName or "Settings",
            Icon = options.SettingsTabIcon or "Settings"
        })
    end
...
function Library:RemoveTheme(name)
    if name ~= "Default" and Themes[name] then
        Themes[name] = nil
        return true
    end
    return false
