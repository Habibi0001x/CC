...
-- Create a window with theme
local Window = Library:CreateWindow({
    Title = "Advanced UI v4.0",
    Description = "Themes • Multi-Dropdowns • Dividers • Descriptions",
    Icon = "Zap",
    Theme = "Ocean",              -- Dark, Light, SkyBlue, Ocean, Purple, Rose, Forest, Sunset, Midnight, Aqua
...
-- Create tab divider
Window:CreateTabDivider({Text = "MAIN"})
...
Window:CreateTabDivider({Text = "CONFIG"})
...
local InfoSection = MainTab:CreateSection({
    Name = "Information",
    Description = "Welcome to the UI Library showcase"
})

InfoSection:CreateLabel({
    Text = "Welcome to the UI!",
    Icon = "Star",
    Description = "This is a label with a description"
})

InfoSection:CreateParagraph({
    Title = "About This Library",
    Content = "This UI library features themes, multi-select dropdowns, element descriptions, section dividers, and much more!"
})

-- Add divider
MainTab:CreateDivider({Text = "FEATURES"})

local FeaturesSection = MainTab:CreateSection({
    Name = "Features",
    Description = "Explore all available elements"
})

FeaturesSection:CreateButton({
    Text = "Click Me",
    Icon = "Play",
    Description = "This button shows a notification when clicked",
    Callback = function()
        Window:Notify({
            Title = "Button Clicked!",
            Content = "You successfully clicked the button.",
            Icon = "Check",
            Type = "Success",
            Duration = 3
        })
...
FeaturesSection:CreateDivider({Text = "Controls"})
...
FeaturesSection:CreateInput({
    Text = "Player Name",
    Icon = "User",
    Description = "Enter a player's name to target",
...
FeaturesSection:CreateDivider({Text = "Dropdowns"})

local SingleDropdown = FeaturesSection:CreateDropdown({
    Text = "Single Select",
    Icon = "ChevronDown",
...
local MultiDropdown = FeaturesSection:CreateDropdown({
    Text = "Multi Select",
    Icon = "Check",
    Description = "Select multiple options from the list",
    Items = {"Aimbot", "ESP", "Fly", "Speed", "Noclip", "Infinite Jump"},
    Default = {"ESP", "Speed"},
    Multi = true,
    MaxVisible = 5,
    Callback = function(selected)
...
FeaturesSection:CreateKeybind({
    Text = "Toggle UI",
    Icon = "Eye",
    Description = "Press this key to toggle the UI",
...
UISettingsSection:CreateToggle({
    ...
    Default = false,
    Callback = function(value)
        Window:SetTransparency(value, 0.3)
    end
})

UISettingsSection:CreateSlider({
    Text = "Transparency Amount",
    Icon = "Sliders",
    Description = "Adjust how transparent the UI is",
    Min = 0,
    Max = 80,
    Default = 30,
    Suffix = "%",
    Callback = function(value)
        Window:SetTransparency(true, value / 100)
    end
})

SettingsTab:CreateDivider({Text = "DIALOGS"})
